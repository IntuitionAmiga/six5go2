...
func resetTED() {
	tedState = TEDState{TED_CTRL_REG_1: 0x00, TED_KEYBOARD_LINE0: 0x00}
}
...
func readTEDReg(address uint16) byte {
	...
	case TED_CTRL_REG_0:
		...
		return tedState.TED_CTRL_REG_0
	case TED_CTRL_REG_1:
		fmt.Printf("Reading TED register %04X TED_CTRL_REG_1\n", address)
		return tedState.TED_CTRL_REG_1
...
func writeTEDReg(address uint16, value byte) {
	...
	case TED_CTRL_REG_0:
		...
		tedState.TED_CTRL_REG_0 = value
	case TED_CTRL_REG_1:
		fmt.Printf("Writing %02X to TED register %04X TED_CTRL_REG_1\n", value, address)
		tedState.TED_CTRL_REG_1 = value
